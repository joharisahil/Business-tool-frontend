          ...
          >
            <div style={{ width: 280, fontSize: 13 }}>
              ...
              >
                <span>CGST</span>
                <span>
                  ₹{invoice.taxBreakdown.cgst.toLocaleString("en-IN")}
                </span>
              </div>
              <div
                style={{
              ...
              >
                <span>SGST</span>
                <span>
                  ₹{invoice.taxBreakdown.sgst.toLocaleString("en-IN")}
                </span>
              </div>
              {invoice.taxBreakdown.igst > 0 && (
                ...
                >
                  <span>IGST</span>
                  <span>
                    ₹{invoice.taxBreakdown.igst.toLocaleString("en-IN")}
                  </span>
                </div>
              )}
              <div
